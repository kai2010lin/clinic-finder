...
class ClinicsControllerTest < ActionController::TestCase
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post :create, clinic: { city: @clinic.city, state: @clinic.state, street: @clinic.street, street_optional: @clinic.street_optional, zip: @clinic.zip }
    end
  ...
  test "should update clinic" do
    patch :update, id: @clinic, clinic: { city: @clinic.city, state: @clinic.state, street: @clinic.street, street_optional: @clinic.street_optional, zip: @clinic.zip }
    assert_redirected_to clinic_path(assigns(:clinic))
  end
